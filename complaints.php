    ...
    <body>
                    ...
                    <div class="col-lg-4 col-md-7 col-sm-8">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <div class="services-content mt-30">
                                <h4 class="services-title"><a href="#">Add a new complaint</a></h4><br>
                                <center> <div class="row mb-4 px-3"> <small class="font-weight-bold"><a class="btn btn-success" data-toggle="modal" data-target="#complaintModal" style="color: white">Submit Complaint</a></small> </div></center>
                            </div>
                        </div>
                    </div> <!-- single services -->
                    </div><!-- 
        ...
        <div class="modal fade" id="complaintModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            <form action="action/action_complaint.php" method="POST" role="form">
                <div col-sm6>
                    <div class="form-group">
                        <label> Complaint</label>
                        <select name="complaint" id="complaint" class="form-control selectpicker"  data-live-search="true" required="required">
                            <option value="">Your complaint type</option>
                            <option value="theft">Theft</option>
                            <option value="manhandling">Manhandling</option>
                            <option value="Fraudalent activity">Fraudalent activity</option>
                            <option value="Murder">Murder</option>
                            <option value="Homicide">Homicide</option>
                            <option value="Sexual crimes">Sexual crimes</option>
                ...
                <div col-sm6>
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="3" required="required" placeholder="Your description of the crime"></textarea>
                    </div>
                </div>
                <div col-sm-6>
                    <div class="form-group">
                        <label>Images</label>
                        <input type="text" class="form-control" name="images" id="images"placeholder="upload images, if any">
                    </div>
                </div>
                <center><button type="submit" class="btn btn-primary">Submit complaint</button></center>
            </form>
