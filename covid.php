                    ...
                    <div class="col-lg-4 col-md-7 col-sm-8">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <div class="services-content mt-30">
                                <h4 class="services-title"><a href="#">Apply for Covid Pass</a></h4><br>
                                <div class="row mb-4 px-3">
                                   <small class="font-weight-bold">
                                    <center><a class="btn btn-success" data-toggle="modal" data-target="#complaintModal" style="color: white">Apply</a></center>
                                </small> 
                            </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Covid Pass Application</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
              </button>
          </div>
          <div class="modal-body">
            <form action="action/action_covid.php" method="POST" role="form">
                <div col-sm6>
                ...
                <div col-sm6>
                    <div class="form-group">
                        ...
                        <select name="proof" id="proof" class="form-control selectpicker"  data-live-search="true" required="required">
                ...
                <div col-sm-6>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="proof_number" id="proof_number" required="required" placeholder="Enter the identity number">
                    </div>
                </div>
                <div col-sm-6>
                    <div class="form-group">
                        <label> Name</label>
                        <input type="text" class="form-control" name="name" id="name" required="required" placeholder="Your name as on the identity proof">
                    </div>
                </div>
                <div col-sm6>
                    <div class="form-group">
