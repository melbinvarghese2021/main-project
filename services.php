                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-title text-center pb-40">
                            ...
                            <h3 class="title">Police services, <span> online for you!</span></h3>
                        </div> <!-- section title -->
                    </div>
                </div> <!-- row -->
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-7 col-sm-8">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <div class="services-content mt-30">
                                <h4 class="services-title"><a href="complaints.php">Complaints</a></h4>
                                <p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod tempor invidunt labore.</p>
                                <a class="more" href="complaints.php">Goto complaints<i class="lni lni-chevron-right"></i></a>
                            </div>
                        </div> <!-- single services -->
                    </div>
                    <div class="col-lg-4 col-md-7 col-sm-8">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                            ...
                            <div class="services-content mt-30">
                                <h4 class="services-title"><a href="applications.php">Applications</a></h4>
                                <p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod tempor invidunt labore.</p>
                                <a class="more" href="applications.php">Goto applications <i class="lni lni-chevron-right"></i></a>
                            </div>
                        </div> <!-- single services -->
                    </div>
                    <div class="col-lg-4 col-md-7 col-sm-8">
                        <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                            ...
                            <div class="services-content mt-30">
                                <h4 class="services-title"><a href="covid.php">Covid Pass</a></h4>
                                <p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu eirmod tempor invidunt labore.</p>
                                <a class="more" href="covid.php">Apply For Covid Pass <i class="lni lni-chevron-right"></i></a>
                            </div>
                    </div> <!-- single services
                </div> -->
            </div> <!-- row -->
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">Want to make a short intra-district travel.</h3>
                        </div> <!-- section title -->
                        <p class="text">Want to make a short travel within your district. Carry a self signed affidavit and provide it with any police officer or covid safety officer on demand.</p>
                        <a href="download.php?file=affidavit.pdf" target="_blank" class="main-btn">Download the affidavit</a>
                    </div> <!-- about content -->
                </div>
                <div class="col-lg-6">
